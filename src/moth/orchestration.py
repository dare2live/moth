...
def prepare_task_context(profile_sources: dict[str, Any], *, task_kind: str, run_id: str, receipts: list[dict[str, Any]], codex_home: str | Path) -> dict[str, Any]:
    ...
    context = build_decision_context(guidance, task_kind=task_kind, run_id=run_id, receipts=receipts)
    return {
