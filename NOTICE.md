...
- **CodeGraph** (<https://github.com/colbymchenry/codegraph>, npm
  ...
  Version check 2026-08-26: GitHub latest release `v1.5.0` (published
  2026-07-21), npm `1.5.0`, locally installed `1.5.0` —— 四处一致,
  当前无可升版本。上次核对 2026-08-14 结论不变。
...
- **complexity-optimizer** (<https://github.com/Kappaemme-git/codex-complexity-optimizer>):
  ...
  Divergence check 2026-08-26 (**该方向的"升级"是破坏性的, 勿照上游覆盖**):
  GitHub `main` 仍只有一个 commit (`6a1f967` 2026-05-15), `analyze_complexity.py`
  377 行, package.json `0.1.1`。本机 skill 自称 `1.0.1`, 且其 `.upstream-commit`
  指向的 sha 在上游**不存在** —— 即本地不是落后而是已分叉领先。
  ...
  2026-08-14 核对结论不变; 没有可合入的上游新 commit。
